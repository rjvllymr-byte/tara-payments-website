...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      operatingSystem: 'Web',
      description:
        'TaraPayments is the leading Xendit GoHighLevel integration that lets Philippine businesses accept GCash, Maya, QRPH, credit cards, and more inside their CRM funnels.',
      url: 'https://payments.taraai.ph',
      offers: {
        '@type': 'Offer',
        price: '39',
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'TaraPayments is a Xendit GoHighLevel integration that enables Philippine businesses to accept GCash, Maya, QRPH, credit cards, and other local payment methods directly inside their CRM.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'TaraPayments connects your Xendit merchant account to GoHighLevel, routing payments through Xendit\'s BSP-regulated infrastructure and triggering CRM automations on successful transactions.',
          },
        },
        {
          '@type': 'Question',
