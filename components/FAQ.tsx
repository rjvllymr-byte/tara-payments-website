const faqs = [
  ...
  {
    q: 'Is TaraPayments officially listed on the GoHighLevel Marketplace?',
    a: 'Yes. TaraPayments is a verified app in the GoHighLevel Marketplace. Search "TaraPayments" inside your GoHighLevel account to install it — no external redirects, no manual configuration.',
  },
  {
    q: 'How does the Xendit GoHighLevel integration handle payment triggers?',
  ...
  {
    q: 'Does TaraPayments work with GoHighLevel sub-accounts?',
